...
def main():
    ...
    parser.add_argument("-opt", type=str, default="options/train/ir-sde.yml", help="Path to option YMAL file.")
    parser.add_argument(
    ...
    sde = util.GOUB(lambda_square=opt["sde"]["lambda_square"], T=opt["sde"]["T"], schedule=opt["sde"]["schedule"],
                     device=device)
